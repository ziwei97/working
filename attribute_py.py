...
data = pd.read_excel("/Users/ziweishi/Desktop/Book3.xlsx")

list = data["guid"].to_list()
# burnNum_pat_loc, BurnIndex

dynamodb = boto3.resource('dynamodb')
table = dynamodb.Table('BURN_ImageCollection')
site = []
DeviceType = []
ImageCollTime = []
ImageCollectionID = []
...
data_tuples = zip(list,site,DeviceType,ImageCollTime,JsonFile,subjectid,burnindex,burnNum_pat_loc)
final = pd.DataFrame(data_tuples, columns=['ImgGUID','Site','DeviceType','ImageCollTime','JsonFile','SubjectID','BurnIndex','burnNum_pat_loc'])
final.to_csv("//Users/ziweishi/Documents/peiran/Peiran_final.csv",encoding='utf-8')
# datatime = []